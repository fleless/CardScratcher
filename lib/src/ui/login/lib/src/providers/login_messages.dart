...
class LoginMessages with ChangeNotifier {
  ...
  static const defaultPasswordHint = 'Mot de passe';
  static const defaultConfirmPasswordHint = 'Confirmer Mot de passe';
  static const defaultForgotPasswordButton = 'Mot de passe oublié?';
  static const defaultLoginButton = 'SE CONNECTER';
  static const defaultSignupButton = "S'INSCRIRE";
  static const defaultRecoverPasswordButton = 'Récupérer';
  static const defaultRecoverPasswordIntro = 'Réinitialiser mot de passe';
  static const defaultRecoverPasswordDescription =
      "On enverra votre mot de passe à l'adresse mail associée.";
  static const defaultGoBackButton = 'RETOUR';
  static const defaultConfirmPasswordError = 'Mot de passe ne correspond pas!';
  static const defaultRecoverPasswordSuccess = 'Un email a été envoyé';
